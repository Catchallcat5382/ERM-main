...
from utils.autocompletes import prc_group_autocomplete, prc_players_autocomplete
...
class ERLC(commands.Cog):
    ...
    @commands.hybrid_group(name="run")
    ...
    @app_commands.autocomplete(target=prc_players_autocomplete)
    ...
    @app_commands.autocomplete(target=prc_group_autocomplete)
    @app_commands.describe(
